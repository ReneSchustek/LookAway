...
/// <summary>
/// Source-generierte Logging-Methoden fuer den <see cref="TrayIconService"/>.
/// </summary>
internal static partial class TrayIconLog
{
    ...
    [LoggerMessage(EventId = 4006, Level = LogLevel.Information, Message = "Ueber-Dialog via Tray angefordert.")]
