...
LookAway prueft optional auf neue Versionen ueber die GitHub-Releases-API (BRIEF020, Standard aktiv):
...
LookAway wird als portable ZIP und als MSIX-Paket verteilt (BRIEF022). Die Versionsnummer ist
