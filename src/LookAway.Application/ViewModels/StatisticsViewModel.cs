...
public sealed partial class StatisticsViewModel : ObservableObject
{
    ...
    [ObservableProperty]
    private int _todaySkipped;

    [ObservableProperty]
    private string _todayBreakTime = string.Empty;

    [ObservableProperty]
    private IReadOnlyList<StatBarViewModel> _weekBars = Array.Empty<StatBarViewModel>();

    [ObservableProperty]
    private IReadOnlyList<StatBarViewModel> _yearBars = Array.Empty<StatBarViewModel>();
