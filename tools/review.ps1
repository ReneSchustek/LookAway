...
.DESCRIPTION
    ...
    project-CLAUDE.md geforderten Maker-Checker-Workflow ohne Cloud-Round-Trips.
    ...
    Modi:
      ...
      enterprise  - all + Report-Skeleton nach .ai/rules/enterprise-review.md
...
.EXAMPLE
    ./tools/review.ps1 -Mode enterprise
#>
[CmdletBinding()]
param(
